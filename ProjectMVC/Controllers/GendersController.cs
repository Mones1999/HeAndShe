...
namespace ProjectMVC.Controllers
{
    public class GendersController : Controller
    {
        ...
        public GendersController(ModelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genders != null ? 
                          ...
                          Problem("Entity set 'ModelContext.Genders'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Genderid,Gendername")] Gender gender)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(decimal id)
        {
            ...
            {
                return Problem("Entity set 'ModelContext.Genders'  is null.");
            }
            var gender = await _context.Genders.FindAsync(id);
            if (gender != null)
            {
        ...
        private bool GenderExists(decimal id)
        {
